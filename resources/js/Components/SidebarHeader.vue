...
<template>
    ...
    <div class="flex flex-col md:pl-64">
        <div
            class="fixed top-0 left-0 right-0 z-10 flex flex-shrink-0 h-16 bg-white shadow"
        >
            <button
    ...
    >
        ...
        <div
        class="relative flex flex-col flex-1 w-full max-w-[15rem] pt-5 pb-4 bg-[#3c65e0]"
        >
            ...
            <Link href="/" class="flex items-center gap-3 px-4 pt-4 pb-2">
                    <img
                        class="w-8 h-8 rounded-full"
                        src="../Components/images/mdc-logo.png"
                        alt="MDC Logo"
                    />
                    <span class="text-lg font-bold tracking-wide text-white">MDC-SAS</span>
                </Link>


                <hr v-show="!isCollapsed" class="mt-2 border-gray-300" />


                <span
                    class="block mt-3 mb-1 ml-4 text-xs font-bold text-gray-200 uppercase select-none"
                    :class="[ isCollapsed ? 'mt-24 text-center ml-0' : '' ]"
                >
                    Menu
                </span>
            ...
            <div class="flex-1 h-0 mt-5 overflow-y-auto">
                ...
                <nav class="px-2 space-y-1">
                    ...
                    >
                        <svg
                            class="flex-shrink-0 w-6 h-6 mr-4 text-gray-300"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
